        ...
        <div className="">
            <Container className="py-12" id="hire-me">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                          ...
                          <span className={`size-10 rounded-lg fcc ${item.bg}`}>
                            <ReactIcon name={item.icon} className={item.color}/>
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className="text-xs text-gray-600 dark:text-gray-400">{item.description}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div>
                        <div
                            className="bg-white dark:bg-gray-900 rounded-2xl ring-1 ring-gray-200 dark:ring-gray-800 px-6 py-4 shadow-sm">
                            <div className="space-y-3">
                                <div className=" font-medium">Send me a proposal</div>
